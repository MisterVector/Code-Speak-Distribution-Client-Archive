...
public class CheckVersionResponse {
    ...
    protected CheckVersionResponse(String requestVersion, Timestamp requestReleaseTime, String version, Timestamp releaseTime) {
     ...
     */
    public static CheckVersionResponse fromJSON(JSONObject json) {
